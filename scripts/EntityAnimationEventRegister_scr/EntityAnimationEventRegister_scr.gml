/// @description EntityAnimationEventRegister_scr(entity, sprite, imageIndex, eventScript, eventArgs, eventID [optional], allowDuplicates [optional])
/// @param entity
/// @param  sprite
/// @param  imageIndex
/// @param  eventScript
...
if(instance_exists(entity) && object_is(entity.object_index, entity_obj))
{
  with(entity)
  {
    ...
    eventMap[? EVENT_ARRAY_SCRIPT] = eventScript;
    eventMap[? EVENT_ARRAY_ARGS] = eventArgs;
    eventMap[? EVENT_ARRAY_ID] = eventID; 
